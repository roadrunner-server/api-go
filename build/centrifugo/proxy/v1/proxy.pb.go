...
func (x *ChannelEvent) Reset() {
	*x = ChannelEvent{}
	mi := &file_centrifugo_proxy_v1_proxy_proto_msgTypes[32]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ChannelEvent) Descriptor() ([]byte, []int) {
	return file_centrifugo_proxy_v1_proxy_proto_rawDescGZIP(), []int{32}
}
...
func (x *NotifyChannelStateResponse) Reset() {
	*x = NotifyChannelStateResponse{}
	mi := &file_centrifugo_proxy_v1_proxy_proto_msgTypes[33]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NotifyChannelStateResponse) Descriptor() ([]byte, []int) {
	return file_centrifugo_proxy_v1_proxy_proto_rawDescGZIP(), []int{33}
}
...
func (x *NotifyChannelStateResult) Reset() {
	*x = NotifyChannelStateResult{}
	mi := &file_centrifugo_proxy_v1_proxy_proto_msgTypes[34]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NotifyChannelStateResult) Descriptor() ([]byte, []int) {
	return file_centrifugo_proxy_v1_proxy_proto_rawDescGZIP(), []int{34}
}
...
var file_centrifugo_proxy_v1_proxy_proto_msgTypes = make([]protoimpl.MessageInfo, 37)
