...
const file_jobs_v2_request_proto_rawDesc = "" +
	"\n" +
	"\x15jobs/v2/request.proto\x12\ajobs.v2\x1a\x12jobs/v2/jobs.proto\"-\n" +
	...
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x80\x01Z@github.com/roadrunner-server/api-go/v5/build/jobs/v2/jobs;jobsV2\xca\x02\x16RoadRunner\\Jobs\\DTO\\V2\xe2\x02\"RoadRunner\\Jobs\\DTO\\V2\\GPBMetadatab\x06proto3"
...
var file_jobs_v2_request_proto_depIdxs = []int32{
	5, // 0: jobs.v2.PushRequest.job:type_name -> jobs.v2.Job
