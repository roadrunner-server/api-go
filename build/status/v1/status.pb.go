...
const file_status_v1_status_proto_rawDesc = "" +
	...
	"\amessage\x18\x02 \x01(\tR\amessageB\x83\x01Z?github.com/roadrunner-server/api-go/v5/build/status/v1;statusV1\xca\x02\x18RoadRunner\\Status\\DTO\\V1\xe2\x02$RoadRunner\\Status\\DTO\\V1\\GPBMetadatab\x06proto3"
...
var file_status_v1_status_proto_goTypes = []any{
	(*Request)(nil),  // 0: status.v1.Request
	(*Response)(nil), // 1: status.v1.Response
}
